...
The screen stops lying about space, the planner stops lying about your plan, and the game starts talking: chips shrink before they vanish, forms keep their cursor on screen, the maneuver planner gets a Plan Cursor, docking says why it refused, the pad tells you how to light the engine, a crash gets a banner, and the Saturn V finally looks like a rocket (UX review 2026-09-02, phases 1-2; #373, #421, #422, #423, #424, #427, #428; PRs `#434`-`#440`; tag `v0.40.0`).

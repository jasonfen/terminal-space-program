...
Slice ready for tag/merge once playtested. Not in scope: the broader
"combined plane-shift + Hohmann" L-tier item (folding a plane change
*into* the transfer burns) stays a v0.11 target — this slice only
makes the standalone `I` plane change physically correct.
